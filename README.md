...
<p class="rb-lede">How Rubaru handles data, money, and agreements — in plain language.</p>
<p class="rb-sub">Rubaru Bank Transfer Discount is a Shopify app that rewards bank‑transfer payments with an automatic discount. It never processes payments or holds funds — money moves directly between buyer and merchant. Below are the documents that govern the app and how we treat your data.</p>
<div class="rb-chips"><span>Processor of buyer data</span><span>Controller of your account</span><span>Not a payment provider</span><span>Data minimized</span></div>
</div>
...
<p class="rb-mono-note">[privacidad@rubaru.tech] · [Legal entity name] · [registered address]</p>
</div>

<p class="rb-note">Last updated [date] · Operated by [Legal entity name]. Rubaru does not process payments or hold funds; money is transferred directly between buyer and merchant.</p>
